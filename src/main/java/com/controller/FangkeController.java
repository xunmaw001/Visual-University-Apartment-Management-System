    ...
    */
    ...
    public R save(@RequestBody FangkeEntity fangke, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            fangke.setSusheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            fangkeEntity.setLaifangTime(new Date(data.get(0)));          //来访时间 要改的
//                            fangkeEntity.setJeishuTime(new Date(data.get(0)));          //结束时间 要改的
