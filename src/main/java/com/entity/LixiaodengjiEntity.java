...
public class LixiaodengjiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LixiaodengjiEntity() {

	}

	public LixiaodengjiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Lixiaodengji{" +
            ...
            ", lixiaodengjiContent=" + lixiaodengjiContent +
