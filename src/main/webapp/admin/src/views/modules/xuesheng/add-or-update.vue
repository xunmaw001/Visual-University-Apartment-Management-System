    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="banjiId" name="banjiId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学号" prop="xuehaoUuidNumber">
                       <el-input v-model="ruleForm.xuehaoUuidNumber"
                                 placeholder="学号" clearable  :readonly="ro.xuehaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="学号" prop="xuehaoUuidNumber">
                           <el-input v-model="ruleForm.xuehaoUuidNumber"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="财务登记" prop="xueshengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengContent" label="财务登记" prop="xueshengContent">
                            <span v-html="ruleForm.xueshengContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xueshengContent: [
                              { required: true, message: '财务登记不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
