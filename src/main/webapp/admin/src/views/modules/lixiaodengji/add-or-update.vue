    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="离校时间" prop="lixiaoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.lixiaoTime"
                                type="datetime"
                                placeholder="离校时间"
                                :disabled="ro.lixiaoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lixiaoTime" label="离校时间" prop="lixiaoTime">
                            <span v-html="ruleForm.lixiaoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="登记内容" prop="lixiaodengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.lixiaodengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lixiaodengjiContent" label="登记内容" prop="lixiaodengjiContent">
                            <span v-html="ruleForm.lixiaodengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   lixiaodengjiContent: [
                              { required: true, message: '登记内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lixiaodengji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lixiaodengjiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
