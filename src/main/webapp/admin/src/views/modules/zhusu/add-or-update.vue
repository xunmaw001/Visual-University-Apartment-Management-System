    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学号" prop="xuehaoUuidNumber">
                        <el-input v-model="xueshengForm.xuehaoUuidNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='xuesheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="状态" prop="zhuangtaiValue">
                        <el-input v-model="xueshengForm.zhuangtaiValue"
                                  placeholder="状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="susheId" name="susheId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="住宿备注" prop="zhusuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhusuContent" label="住宿备注" prop="zhusuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zhusuContent: [
                              { required: true, message: '住宿备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhusu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhusuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
